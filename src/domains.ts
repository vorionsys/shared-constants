...
export const API_ENDPOINTS = {
  ...
  /** Agent Anchor AI Production API (served from the app host, not a dedicated api subdomain) */
  agentAnchor: {
    production: 'https://app.agentanchorai.com/api',
  },

  /** Trust Signal Dashboard API (served from the trust.vorion.org host) */
  trust: {
    production: 'https://trust.vorion.org/api',
  },

  /** Logic/Policy Playground API (served from the logic.vorion.org host) */
  logic: {
    production: 'https://logic.vorion.org/api',
  },
} as const;
