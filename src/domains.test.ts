...
describe('API_ENDPOINTS', () => {
  ...
  it('has agentAnchor endpoints', () => {
    expect(API_ENDPOINTS.agentAnchor.production).toContain('app.agentanchorai.com/api');
  });

  it('has trust endpoint on vorion.org subdomain', () => {
    expect(API_ENDPOINTS.trust.production).toContain('trust.vorion.org');
  });

  it('has logic endpoint on vorion.org subdomain', () => {
    expect(API_ENDPOINTS.logic.production).toContain('logic.vorion.org');
  });
